...
<div class="container pt-5 m">
    <div class="row">
        <div class="col-md-8 offset-md-2">
           ...
           <h4> Tambah Data Matakuliah
               <a href="<?= base_url('products')  ?>"class="btn btn-warning offset-md-6">BACK</a>
           </h4>
                </div>
   ...
   <form action="<?php echo base_url('products/add'); ?> " method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                                  ...
                                  <input type="text"  name="kd_mk" class="form-control" placeholder="Masukkan kode Matakuliah" autofocus >
                                  <small><?php echo form_error('kd_mk'); ?> </small>
                              </div>

                              <div class="form-group">
                                  <label for="">nama_mk</label>
                                  <input type="text"  name="nama_mk" class="form-control" placeholder="Masukkan Nama Matakuliah" >
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="Tanggal_ambil" class="form-control" placeholder="Masukkan Tanggal ambil" >
                              ...
                              <div class="form-group pt-3">
                               <button type="submit"  name ="product_save" class="btn btn-primary px-5">Save</button>
                              </div>
